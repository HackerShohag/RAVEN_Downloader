        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Text {
                    ...
                    color: enabled ? theme.palette.normal.backgroundText : UbuntuColors.lightGrey
                }
                CheckBox {
                    id: captionCheckBox
                    Layout.alignment: Qt.AlignRight
            ...
            OptionSelector {
                ...
                onSelectedIndexChanged:  {
                    if (themeModel[selectedIndex] == "Ambiance theme")
                        generalSettings.theme = "Ubuntu.Components.Themes.Ambiance"
                    if (themeModel[selectedIndex] == "Suru-dark theme")
                        generalSettings.theme = "Ubuntu.Components.Themes.SuruDark"
                    else
